...
int main(int argc, char **argv) {
  ...
  cmate_arg_t run = {
     "r", "run",
     "<project>", "Run the specified project (use -- to pass arguments to the program)",
     NULL, 0};
  ...
  cmate_arg_t init = {"i", "init", NULL, "Generate a project.toml file", NULL, 0};
  ...
  output_file = safe_strdup(output.count > 0 ? output.value : DEFAULT_OUTPUT_FILE);
